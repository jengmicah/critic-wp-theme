...
if ( comments_open() ) { ?>
	<section id="comments" class="comments">
		<div class="comments-number">
			<h2>
				<?php comments_number( __( 'Be First to Comment', 'critic' ), __( 'One Comment', 'critic' ), _x( '% Comments', 'noun: 5 comments', 'critic' ) ); ?>
			</h2>
		</div>
		<ol class="comment-list">
			<?php wp_list_comments( array( 'callback' => 'ct_critic_customize_comments' ) ); ?>
		</ol>
		<?php
	...
	<section id="comments" class="comments">
		...
		<p class="comments-closed pings-open">
			<?php printf( __( 'Comments are closed, but <a href="%s" title="Trackback URL for this post">trackbacks</a> and pingbacks are open.', 'critic' ), esc_url( get_trackback_url() ) ); ?>
		</p>
	</section>
	<?php
	...
	<section id="comments" class="comments">
		...
		<p class="comments-closed">
			<?php _e( 'Comments are closed.', 'critic' ); ?>
		</p>
	</section>
	<?php
} else { ?>
