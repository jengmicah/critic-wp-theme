...
jQuery(document).ready(function($){
    ...
    var toggleDropdown = $('.menu-item-has-children');
    ...
    function openPrimaryMenu() {
        ...
        if( sidebar.hasClass('open') ) {
            ...
            $(this).children('span').text(ct_critic_objectL10n.openPrimaryMenu);
            ...
            // update screen reader text and aria-expanded
            $(this).children('span').text(ct_critic_objectL10n.closePrimaryMenu);
    ...
    function openDropdownMenu() {
        ...
        if( menuItem.hasClass('open') ) {
            ...
            $(this).children('span').text(ct_critic_objectL10n.openChildMenu);
            $(this).attr('aria-expanded', 'false');
        } else {
            menuItem.addClass('open');
            $(this).children('span').text(ct_critic_objectL10n.closeChildMenu);
            $(this).attr('aria-expanded', 'true');
